...
$BuildTargets += New-Object PSObject -Property @{ Platform = "desktop"; Target = "arm";  Architecture = 32; Postfix = "/arm";   RID = "$OperatingSystem-arm";   }
...
foreach($BuildTarget in $BuildTargets)
{
   ...
   {
      Write-Host "Start 'docker run --rm -v ""$($OpenJpegDotNetRoot):/opt/data/OpenJpegDotNet"" -e LOCAL_UID=$(id -u $env:USER) -e LOCAL_GID=$(id -g $env:USER) -t $dockername'" -ForegroundColor Green
