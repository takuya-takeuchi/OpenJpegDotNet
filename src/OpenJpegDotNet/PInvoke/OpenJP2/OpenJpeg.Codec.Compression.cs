...
namespace OpenJpegDotNet
{
    ...
    internal sealed partial class NativeMethods
    {
        ...
        [DllImport(NativeLibrary, CallingConvention = CallingConvention)]
        [return: MarshalAs(UnmanagedType.U1)]
        public static extern bool openjpeg_openjp2_opj_setup_encoder(IntPtr p_codec, IntPtr parameters, IntPtr image);

        [DllImport(NativeLibrary, CallingConvention = CallingConvention)]
        [return: MarshalAs(UnmanagedType.U1)]
        public static extern bool openjpeg_openjp2_opj_start_compress(IntPtr p_codec, IntPtr p_image, IntPtr p_stream);
