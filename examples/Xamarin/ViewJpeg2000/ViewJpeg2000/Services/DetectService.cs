...
using Object = ViewJpeg2000.Models.Object;
...
namespace ViewJpeg2000.Services
{
    ...
    public sealed class DetectService : IDetectService
    {
        ...
        {
            var resourcePrefix = $"ViewJpeg2000.data.";
        ...
        private static int DetectViewJpeg2000(NcnnDotNet.OpenCV.Mat bgr, List<Object> objects)
        {
